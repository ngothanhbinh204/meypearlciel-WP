				...
				<div class="header-right-inner">
						...
						<div class="header-language-active">
							<ul>
								<?php foreach ($wpml_languages as $lang) : if ($lang['active']) : ?>
									<li class="wpml-ls-current-language"><a href="<?php echo esc_url($lang['url']); ?>"><span class="wpml-ls-native"><?php echo esc_html(strtoupper($lang['language_code'])); ?></span></a></li>
								<?php endif; endforeach; ?>
								<ul>
									<?php foreach ($wpml_languages as $lang) : if (!$lang['active']) : ?>
										<li><a href="<?php echo esc_url($lang['url']); ?>"><span><?php echo esc_html(strtoupper($lang['language_code'])); ?></span></a></li>
									<?php endif; endforeach; ?>
								</ul>
							</ul>
						</div>
					...
					<div class="header-bar relative cursor-pointer" id="burger">
						<div class="burger-ratio img-ratio">
							<svg class="default-burger" xmlns="http://www.w3.org/2000/svg" width="53" height="16" viewBox="0 0 53 16" fill="none">
							...
							<div class="burger-open absolute pointer-events-none opacity-0 invisible">
								<svg class="open-burger" width="53" height="16" viewBox="0 0 53 16" fill="none" xmlns="http://www.w3.org/2000/svg">
									<rect x="1" y="1" width="53" height="2" transform="rotate(14 1 1)" fill="white"/>
									<rect x="1" y="14.0002" width="53" height="2" transform="rotate(-14 1 14.0002)" fill="white"/>
								</svg>
							</div>
						</div>
					</div>
...
<div class="nav-mobile fixed top-header right-0 w-full z-[200] flex flex-col">
	<div class="vector" aria-hidden="true">
		<img class="img-svg" src="<?php echo esc_url(get_template_directory_uri() . '/img/vector-home-nav.svg'); ?>" alt="">
	</div>
			...
			<div class="nav-menu">
				...
				<div class="nav-search xl:mt-12 mt-6">
					<div class="wrap-form-search relative">
						...
						<button aria-label="<?php esc_attr_e('Tìm kiếm', 'canhcamtheme'); ?>"><i class="fa-light fa-magnifying-glass"></i></button>
					</div>
				</div>
			</div>
		</div>
