...
<section class="home-6 relative overflow-hidden">
	...
	<div class="swiper-column-auto relative" data-speed="700">
		<div class="swiper">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide bg-Secondary-1 pt-10 xl:pb-25 pb-10">
					<div class="vector">
						<img class="img-svg"
							src="<?php echo esc_url(get_template_directory_uri() . '/img/vector-home6-embed.svg'); ?>"
							alt="">
					</div>
					<div class="wrap-container xl:rem:pl-[160px] xl:pr-20 px-4">
						<div
							class="wrapper-main grid lg:grid-cols-[calc(884/1680*100%)_1fr] grid-cols-1 gap-4 xl:rem:gap-[146px]">
							<div class="col-left">
								<div
									class="wrap-left grid lg:grid-cols-[calc(450/884*100%)_1fr] xl:rem:gap-[47px] xl:rem:mt-[200px] gap-5">
									<?php if ($img_left) : ?>
									<div class="img">
										<a class="img-ratio ratio:pt-[580_450]" href="#">
											<img class="lozad" data-src="<?php echo esc_url($img_left); ?>"
									...
									<div class="content">
										<?php if ($name) : ?>
										<div
											class="title heading-2 font-fontHeading font-bold uppercase mb-2 text-Primary-1">
											<?php echo esc_html($name); ?>
										</div>
										<?php endif; ?>
										<?php if ($sub_title) : ?>
										<div
											class="sub-title heading-hightlight font-normal text-Primary-1 font-secondary mb-6">
		...
		<div class="arrow-button flex items-center gap-5">
			<div class="btn btn-sw-1 btn-prev style-blue"><img class="img-svg"
					src="<?php echo esc_url(get_template_directory_uri() . '/img/arrow-left.svg'); ?>" alt=""></div>
			<div class="btn btn-sw-1 btn-next style-blue"><img class="img-svg"
